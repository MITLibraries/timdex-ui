...
- `SEMANTIC_LOGGER_MULTILINE`: development only config. Defaults to true/enabled, set to false for development logs to be a single line. Leave unset for more readable logs at the expense of more terminal scrolling.
