...
class SearchHelperTest < ActionView::TestCase
  ...
  test 'primo_search_url handles special characters in query' do
    ...
    expected_url = 'https://mit.primo.exlibrisgroup.com/discovery/search?query=any%2Ccontains%2Cdata+%26+analytics&tab=all&search_scope=all&vid=01MIT_INST%3AMIT'
    assert_equal expected_url, primo_search_url(query)
  end
